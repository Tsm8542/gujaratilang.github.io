...
function s(){
    ...
    switch(a){
        ...
        case 'kumarbharti':
            ...
            break;
        case 'sahitya_parichay':
            m.innerHTML = create_option("std","Std ",6,7);
            break;
        case 'yuvakbharti':
...
function x(){
    ...
    else if(document.querySelector("#genre").value=="gujarati_composite"){
        switch(s){
            case 'std8':
                tg("true");
    ...
    else if(document.querySelector("#genre").value=="gujarati_full"){
        switch(s){
            case 'std8':
                tg("true");
    ...
    else if(document.querySelector("#genre").value=="sahitya_parichay"){
        switch(s){
            case 'std6':
                tg("true");
...
function z(){
    ...
    if(genre=="balbharti")genre="Balbharti Gujarati";
    else if(genre=="gujarati_composite")genre="Gujarati Composite";
    else if(genre=="gujarati_full")genre="Gujarati Full";
    else if(genre=="kumarbharti")genre="Kumarbharti Gujarati";
    else if(genre=="sahitya_parichay")genre="Sahitya Parichay Gujarati (Literature Education)";
    else if(genre=="yuvakbharti")genre="Yuvakbharti Gujarati";
    let m="";
